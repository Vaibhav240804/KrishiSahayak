...
class CommodityPrices extends StatelessWidget {
  const CommodityPrices({Key? key}) : super(key: key);
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        CommodityRecord currentRecord = stateWiseRecords[index];
                        return ListTile(
    ...
    if (marketProvider.statewizeRecords.isEmpty) {
      try {
        await marketProvider
            .getCommodityRecords(Provider.of<UserProvider>(context).user.state);
      } catch (e) {
